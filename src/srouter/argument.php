...
/**
*describes the mapping of controller argument method to the request via the 
*router each argument has a name (the argument name), a source (implementation
...
/**
*returns the argument name so it can be retrieved from the request and mapped 
*to the PHP argument. usually would be just the same as the PHP name.
*/
...
*arrays will be trimmed by the parameter_maker class.
*/
...
*attempt to locate parameters for all arguments.
*/
